...
export function bold(l: Label, sz: SizeKey, cfg: AppConfig): string {
  ...
  const header = `<div style="background:${dark};padding:2px 4px;display:flex;align-items:center;justify-content:space-between;height:${hdrH}px;gap:2px;overflow:hidden;flex-shrink:0">
